...
KERNEL_SPECS="oneplus3t;oos;oos3xx;http://kernel.boeffla.de/oneplus3t/boeffla-kernel-oos/;boeffla-kernel-#VERSION#-OOS3xx-OnePlus3T-anykernel.recovery.zip"
